declare module 'spargojs/index' {
  export * from 'spargojs/spargo';
  //# sourceMappingURL=index.d.ts.map
}
declare module 'spargojs/index.d.ts' {
  {"version":3,"file":"index.d.ts","sourceRoot":"","sources":["../../../home/justin/Projects/spargo/src/index.ts"],"names":[],"mappings":"AAAA,cAAc,UAAU,CAAC"}
}
